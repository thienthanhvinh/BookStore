...
<div class="flex">
    ...
    <div class="bg-gray-100 basis-[82%] px-9 py-10">
        <div class="add-product-container bg-[#fff] py-5 px-8 rounded-xl">
            <h3 class="text-2xl font-semibold text-gray-600">List Product</h3>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="flex items-center gap-3 justify-center">
                            ...
                            <p class="basis-2/3 text-gray-500 font-semibold truncate whitespace-nowrap overflow-hidden w-fit max-w-[12ch]">A story of my life</p>
                        </td>
                        <td>Watch</td>
                        <td>$250</td>
                        <td>$230</td>
                    ...
                    <tr>
                        ...
                        <td class="flex items-center gap-3 justify-center">
                            <div class="basis-1/3">
                                <img class="w-full h-[50px] rounded-lg object-cover" src="<?php echo $base_url . "images/book-2.png" ?>" alt="">
                            </div>
                            <p class="basis-2/3 text-gray-500 font-semibold truncate whitespace-nowrap overflow-hidden w-fit max-w-[12ch]">A story of my life</p>
                        </td>
                        <td>Watch</td>
                        ...
                        <td>20</td>
                        <td>
                            <p class="px-2 py-1 bg-red-300 text-red-500 rounded-lg">Draf</p>
                        </td>
                        <td>Danang</td>
                        <td>
                            <div class="flex gap-2 items-center justify-center">
                    ...
                    <tr>
                        ...
                        <td class="flex items-center gap-3 justify-center">
                            <div class="basis-1/3">
                                <img class="w-full h-[50px] rounded-lg object-cover" src="<?php echo $base_url . "images/book_template.png" ?>" alt="">
                            </div>
                            <p class="basis-2/3 text-gray-500 font-semibold truncate whitespace-nowrap overflow-hidden w-fit max-w-[12ch]">A story of my life</p>
                        </td>
                        <td>Watch</td>
