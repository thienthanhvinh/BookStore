    ...
    <div class="bg-gray-100 basis-[82%] px-9 py-10">
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="add-product-container bg-[#fff] py-5 px-8 rounded-xl">
                ...
                <h3 class="text-2xl font-semibold text-gray-600">Edit Page</h3>
                <div class="flex items-center gap-2 text-lg mt-5">
                    <a href="">Dashboard ></a>
                    <a href="" class="text-blue-500">Edit Page</a>
                </div>
                    ...
                    <div class="basis-1/2 rounded-xl py-3">
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <div class="w-[25%] h-[160px] mt-1">
                                    <img class="w-full h-full rounded-xl" src="<?php echo $base_url . "/images/book-2.png" ?>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
