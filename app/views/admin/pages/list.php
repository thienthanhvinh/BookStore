...
<div class="flex">
    ...
    <div class="bg-gray-100 basis-[82%] px-9 py-10">
        <div class="add-product-container bg-[#fff] py-5 px-8 rounded-xl">
            <h3 class="text-2xl font-semibold text-gray-600">List Page</h3>
            ...
            <table class="table-post shadow-mainShadow mt-9">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <p class="description-page truncate whitespace-nowrap overflow-hidden w-fit max-w-[12ch]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore, hic?</p>
                        </td>
                        <td>
                            <p class="intro-detail text-center truncate whitespace-nowrap overflow-hidden w-fit max-w-[20ch]">Mission Detail Lorem ipsum dolor sit amet.</p>
                        </td>
                        <td>
                            <p class="mission-detail">History</p>
                        </td>
                        <td>
                            Admin
                        </td>
