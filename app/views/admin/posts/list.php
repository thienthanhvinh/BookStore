...
<div class="flex">
    ...
    <div class="bg-gray-100 basis-[82%] px-9 py-10">
        <div class="add-product-container bg-[#fff] py-5 px-8 rounded-xl">
            <h3 class="text-2xl font-semibold text-gray-600">List Post</h3>
            ...
            <div class="mt-2">
                <div class="flex items-center gap-5">
                    ...
                    <div class="flex items-center gap-2">
                        <p>Published</p>
                        <span class="bg-green-300 text-green-600 rounded-lg px-2 py-1">3</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <p>Draf</p>
                ...
                <div class="search-container mt-5 flex items-center gap-6">
                    ...
                    <div class="basis-[40%] flex items-center gap-6">
                        <div class="basis-1/2">
                            <select name="" id="" class="border border-gray-300 rounded-lg px-4 py-2 w-full">
                                <option value="">All</option>
                                <option value="">History</option>
                            </select>
                        </div>

                        <div class="basis-1/2 flex gap-3">
            ...
            <table class="table-post shadow-mainShadow mt-9">
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>A Story of my life</td>
                        <td><img class="w-full h-[50px] rounded-lg object-cover" src="<?php echo $base_url . "images/LNG.png" ?>" alt=""></td>
                        <td>
                            <p class="basis-2/3 text-gray-500 font-semibold">Alexander Rhoes</p>
                        </td>
                        <td>
                            <p class="text-center truncate whitespace-nowrap overflow-hidden w-fit max-w-[12ch]">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque, reiciendis!</p>
                        </td>
                        <!-- <td>
                            <p class="truncate whitespace-nowrap overflow-hidden w-fit max-w-[20ch]">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores aliquid consequatur illum laborum, mollitia cumque dolore commodi similique architecto nihil?
                            </p>
                        </td> -->
                        <td>History</td>
                        <td>
                        ...
                        <td>
                            <p class="px-2 py-1 bg-green-300 text-green-500 rounded-lg">Published</p>
                        </td>
                        <td>
