...
<div class="product-section mt-16">
    <div class="trending-books">
        ...
        <!-- <div class="max-w-sm mx-auto">
            <div id="product-demo" class="group relative bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-md hover:shadow-lg  opacity-0 transition-all duration-700">
                <img
                    src="https://cdn.oneesports.vn/cdn-data/sites/4/2024/10/lmht-cktg-2024-blg-vao-chung-ket-1024x576.jpg"
                    alt="Product Image"
                ...
                <div
                    class="absolute bottom-4 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-500">
                    <button class="bg-indigo-600 text-white px-4 py-2 rounded-full shadow-lg hover:bg-indigo-700 transition-colors">
                        Add to Cart
                    </button>
                </div>
            </div>
                        ...
                        <div class="relative group">
                            <div class="w-full h-[260px] px-4">
                                <a href="index.php?controller=product&action=detail&id=<?php echo $product['product_id'] ?>">
                                    <img class="w-full h-full object-cover rounded-xl transform group-hover:scale-105 transition-transform duration-500" src="<?php echo $base_url ?>/uploads/images/<?php echo $product['product_image'] ?>" alt="">
                                </a>
                            </div>
    ...
    <div class="deal-week">
        ...
        <div class="flex mt-8 gap-11">
            <?php if (!empty($dealOfWeek)) { ?>
                <div class="flex flex-wrap items-center basis-2/3 gap-4 h-[640px] flex-1">
                    <?php foreach ($dealOfWeek as $product) { ?>
                        <div class="deal-week opacity-0 -translate-x-10 transition-all duration-700 bg-mainProduct shadow-mainShadow rounded-3xl flex items-center gap-6 px-4 w-[49%] h-[300px] mb-3">
                            <div class="w-[45%] h-[85%]">
                                <img class="w-full h-full object-cover rounded-xl" src="<?php echo $base_url ?>/uploads/images/<?php echo $product['product_image'] ?>" alt="">
                            </div>
                            <div class="flex flex-col gap-1">
                                ...
                                <a href="" class="mt-2 flex gap-2 items-center px-6 py-2 text-white bg-mainColor rounded-3xl hover:bg-[#e67e22] transition-all duration-300 text-center">
                                    <span>
                                        <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
            ...
            <div id="animated-deal-right" class="basis-1/3 flex rounded-3xl flex-col gap-3 opacity-0 translate-x-10 transition-all duration-700" style="background: radial-gradient(109.98% 137.68% at 97.16% 0%, #A1E9FF 0%, #7389FF 39.41%, #081F73 100%);">
                ...
                <div class="h-full">
                    <img class="w-full h-full rounded-3xl object-cover" src="<?php echo $base_url . 'images/group-img.png' ?>" alt="">
                </div>
