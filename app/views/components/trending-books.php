...
<?php if (!empty($trendingProducts)) { ?>
    <?php foreach ($trendingProducts as $product) { ?>
        <div class="BookContainerInfor product-card bg-white shadow-md rounded-3xl py-6 px-4 group relative border border-gray-200 overflow-hidden hover:shadow-lg">
